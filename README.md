...
- JSON imports restore personal scores and keep them out of community until the relevant rating screen is reopened and closed once. That single close action promotes all saved scores in that scope; no driver-by-driver re-entry is needed. Exports use version 2; version 1 imports remain supported.
